...
async def start_command(ctx):
    ...
    await info(ctx)
#Bu kod ile botun komutlarını öğrenebilirsiniz
...
#Bu kod ile yeni projeler ekleyebilir ve durumlarını belirleyebilirsiniz
...
#Bu kod ile database'inizdeki projeleri ve linklerini görebilirsiniz
...
#Bu kod ile projelere beceriler ekleyebilirsiniz
...
async def skills(ctx):
    ...
    if projects:
        ...
        await ctx.send('Henüz herhangi bir projeniz yok!\nBir tane eklemeyi düşünün! !new_project komutunu kullanabilirsiniz.')
#Bu kod ile database'inizdeki projeleri silebilirsiniz
...
async def delete_project(ctx):
    ...
    if projects:
        ...
        await ctx.send('Henüz herhangi bir projeniz yok!\nBir tane eklemeyi düşünün! !new_project komutunu kullanabilirsiniz.')
#Bu kod ile projelerinizin özelliklerini güncelleyebilirsiniz
